...
enum NodeTag : int {
  ...
  NodeTag_INT_MIN_SENTINEL_DO_NOT_USE_ = std::numeric_limits<int32_t>::min(),
  NodeTag_INT_MAX_SENTINEL_DO_NOT_USE_ = std::numeric_limits<int32_t>::max()
};
...
inline bool NodeTag_Parse(
    ::PROTOBUF_NAMESPACE_ID::ConstStringParam name, NodeTag* value) {
...
enum RemoteQueryExecType : int {
  ...
  EXEC_ON_ALL_NODES = 2,
  EXEC_ON_NONE = 3,
  RemoteQueryExecType_INT_MIN_SENTINEL_DO_NOT_USE_ = std::numeric_limits<int32_t>::min(),
  RemoteQueryExecType_INT_MAX_SENTINEL_DO_NOT_USE_ = std::numeric_limits<int32_t>::max()
};
...
inline bool RemoteQueryExecType_Parse(
    ::PROTOBUF_NAMESPACE_ID::ConstStringParam name, RemoteQueryExecType* value) {
...
enum RelationAccessType : int {
  ...
  RelationAccessType_INT_MIN_SENTINEL_DO_NOT_USE_ = std::numeric_limits<int32_t>::min(),
  RelationAccessType_INT_MAX_SENTINEL_DO_NOT_USE_ = std::numeric_limits<int32_t>::max()
};
...
inline bool RelationAccessType_Parse(
    ::PROTOBUF_NAMESPACE_ID::ConstStringParam name, RelationAccessType* value) {
