...
const uint32_t TableStruct_enumtag_2eproto::offsets[1] = {};
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_enumtag_2eproto = {
  false, false, 15514, descriptor_table_protodef_enumtag_2eproto, "enumtag.proto", 
  &descriptor_table_enumtag_2eproto_once, nullptr, 0, 0,
  schemas, file_default_instances, TableStruct_enumtag_2eproto::offsets,
  nullptr, file_level_enum_descriptors_enumtag_2eproto, file_level_service_descriptors_enumtag_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable* descriptor_table_enumtag_2eproto_getter() {
  return &descriptor_table_enumtag_2eproto;
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY static ::PROTOBUF_NAMESPACE_ID::internal::AddDescriptorsRunner dynamic_init_dummy_enumtag_2eproto(&descriptor_table_enumtag_2eproto);
namespace proto_plan {
